...
class AppLocalizationsMl extends AppLocalizations {
  ...
  String get locationServicesRequired =>
      'ഈ ആപ്പ് ഉപയോഗിക്കാൻ സ്ഥാനം സേവനങ്ങൾ ആവശ്യമാണ്.';

  @override
  String get failedToLoadInsights =>
      'ഉൾക്കാഴ്ചകൾ ലോഡ് ചെയ്യുന്നതിൽ പരാജയപ്പെട്ടു';
  ...
  String get pleaseEnterNameAndPhone =>
      'ദയവായി നിങ്ങളുടെ പേര് और ഫോൺ നമ്പർ നൽകുക';
  ...
  String get failedToSendOTP =>
      'OTP അയയ്ക്കുന്നതിൽ പരാജയം. ദയവായി വീണ്ടും ശ്രമിക്കുക.';
  ...
  String get shareYourThoughts =>
      'നിങ്ങളുടെ ആശയങ്ങൾ പങ്കിടുക, ചോദ്യങ്ങൾ ചോദിക്കുക, സഹ കർഷകരുമായി ബന്ധപ്പെടുക.';
  ...
  String get shareYourFarmingExperiences =>
      'നിങ്ങളുടെ കൃഷിയനുഭവങ്ങൾ, നുറുങ്ങുകൾ പങ്കിടുക, സഹ കർഷകരുമായി ബന്ധപ്പെടുക';
  ...
  String get weatherUpdatesDesc =>
      'നിലവിലെ കാലാവസ്ഥ, ആർദ്രത, കാറ്റിന്റെ వేగം, 3-ദിവസ പ്രവചനങ്ങൾ వంటి నిజസమయంలో കാലാവസ്ഥാ വിവരങ്ങൾ పొందండి.';
  ...
  String get aiChatDesc =>
      'നിങ്ങളുടെ കൃഷി സംബന്ധമായ ప్రశ്നങ്ങൾക്ക് വ്യക്തിഗത ഉപദേശം, വിള ശുപാർശകൾ, മറുപടികൾക്കായി ഞങ്ങളുടെ AI-ശക്തമായ കൃഷി വിദഗ്ധനുമായി ചാറ്റ് ചെയ്യുക.';
  ...
  String get pestDetectionDesc =>
      'നിങ്ങളുടെ വിളകളുടെ ഫോട്ടോകൾ അപ്‌ലോഡ് ചെയ്ത് സാധ്യതയുള്ള പൂച്ചിക്കണ്ടൽ പ്രശ്നങ്ങളെ തിരിച്ചറിയുക, ചികിത്സയും నివാരണയും സംബന്ധിച്ച ശുപാർശകൾ పొందുക.';
  ...
  String get communityDesc =>
      'ఇతర రైతులతో కనెక్ట్ అవ్వండి, అనుభవాలను పంచుకోండి, ప్రశ్నలు అడగండి, మరియు కృషి సమాజం నుండి నేర్చుకోండి.';
  ...
  String get multiLanguageDesc =>
      'ఇంగ్లీష్, హిందీ, తమిళ్, తెలుగు మరియు മലയാളం మద్దతుతో మీ ఇష్టమైన భాషలో యాప్‌ను ఉపయోగించండి.';
  ...
  String get profileManagementDesc =>
      'వ్యక్తిగత సమాచారం, పంట ప్రాధాన్యతలు మరియు వ్యక్తిగతీకరించిన సిఫారసుల కోసం స్థానం సెట్టింగ్స్‌ను నిర్వహించండి.';

  @override
  String get gettingStartedStep1 =>
      '1. మీ స్థానం మరియు పంట ప్రాధాన్యతలతో మీ ప్రొఫైల్‌ను సెట్ చేయండి';

  @override
  String get gettingStartedStep2 =>
      '2. ఖచ్చితమైన వాతావరణ అప్డేట్స్ కోసం స్థానం యాక్సెస్‌ను అనుమతించండి';

  @override
  String get gettingStartedStep3 =>
      '3. హోమ్ స్క్రీన్‌లో వాతావరణ అంచనాలు మరియు కృషి అంతర్దృష్టులను అన్వేషించండి';

  @override
  String get gettingStartedStep4 =>
      '4. వ్యక్తిగత కృషి సలహాల కోసం HarvestBot తో చాట్ చేయండి';

  @override
  String get gettingStartedStep5 =>
      '5. മറ്റു കര്‍ഷകരുമായി ബന്ധപ്പെടാന്‍ സമൂഹത്തില്‍ ചേരുക';
  ...
  String get weatherUsageDesc =>
      'നിലവിലെ കാലാവസ്ഥ, 3-ദിവസ പ്രവചനങ്ങള്‍, 30-ദിവസ വിപുലമായ പ്രവചനങ്ങള്‍ കാണുക. വിശദമായ കലണ്ടര്‍ കാഴ്ചയ്ക്ക് \'കൂടുതല്‍ കാണുക\' അമര്‍ത്തുക.';
  ...
  String get aiChatUsageDesc =>
      'വിളകള്‍, രോഗങ്ങള്‍, വളങ്ങള്‍, അല്ലെങ്കില്‍ മറ്റ് കൃഷി വിഷയങ്ങളില്‍ ചോദ്യങ്ങള്‍ ചോദിക്കുക. നിങ്ങളുടെ സംഭാഷണത്തിന്റെ അടിസ്ഥാനത്തില്‍ AI പ്രസക്തമായ മറുപടികള്‍ നല്‍കും.';
  ...
  String get pestDetectionUsageDesc =>
      'ബാധിതമായ ചെടികളുടെ വ്യക്തമായ ഫോട്ടോകള്‍ എടുക്കുക. സിസ്റ്റം വിശകലനം ചെയ്ത് തിരിച്ചറിയലും ചികിത്സാ ശുപാര്‍ശകളും നല്‍കും.';
  ...
  String get communityUsageDesc =>
      'പോസ്റ്റുകളും ഫോട്ടോകളും അനുഭവങ്ങളും പങ്കിടുക. മറ്റുള്ളവരുടെ പോസ്റ്റുകളില്‍ അഭിപ്രായം രേഖപ്പെടുത്തി കര്‍ഷക സുഹൃത്തുക്കളുമായി ബന്ധം സ്ഥാപിക്കുക.';
  ...
  String get locationIssuesDesc =>
      'ശരിയായ കാലാവസ്ഥാ ഡാറ്റയ്ക്കായി നിങ്ങളുടെ ഉപകരണത്തിലെ സ്ഥാനം സേവനങ്ങള്‍ സജീവമാണെന്ന് ഉറപ്പാക്കുക.';
  ...
  String get weatherNotLoadingDesc =>
      'നിങ്ങളുടെ ഇന്റര്‍നെറ്റ് കണക്ഷനും സ്ഥാനം അനുമതികളും പരിശോധിക്കുക. ഹോം സ്‌ക്രീന്‍ പുതുക്കാന്‍ താഴേക്ക് വലിക്കുക.';
  ...
  String get aiNotRespondingDesc =>
      'നല്ല ഇന്റര്‍നെറ്റ് കണക്ഷന്‍ ഉണ്ടെന്ന് ഉറപ്പാക്കുക. AI മനസ്സിലാക്കുന്നില്ലെങ്കില്‍ നിങ്ങളുടെ ചോദ്യങ്ങള്‍ പുനരാഖ്യാനം ചെയ്യാന്‍ ശ്രമിക്കുക.';

  @override
  String get contactSupportDesc =>
      'കൂടുതല്‍ സഹായത്തിനോ പ്രശ്നങ്ങള്‍ റിപ്പോര്‍ട്ട് ചെയ്യാനോ, നിങ്ങള്‍ക്ക്:';
  ...
  String get reportIssue =>
      'ആപ്പിലെ ഫീഡ്ബാക്ക് വഴി പ്രശ്നങ്ങള്‍ റിപ്പോര്‍ട്ട് ചെയ്യുക';

  @override
  String get visitWebsite =>
      'ഞങ്ങളുടെ വെബ്സൈറ്റ് സന്ദര്‍ശിക്കുക: www.harvesthub.com';
  ...
  String get uploadPlantImageDesc =>
      'കീടങ്ങളെയും രോഗങ്ങളെയും കണ്ടെത്താൻ ചെടിയുടെ ഇലകളുടെ വ്യക്തമായ ഫോട്ടോ എടുക്കുകയോ ഗാലറിയിൽ നിന്ന് അപ്‌ലോഡ് ചെയ്യുകയോ ചെയ്യുക.';
  ...
  String get uploadImageToGetStarted =>
      'ആരംഭിക്കാൻ ഒരു ചിത്രം അപ്‌ലോഡ് ചെയ്യുക';
  ...
  String get cropsHealthyMessage =>
      'നിങ്ങളുടെ വിളകൾ ആരോഗ്യകരമായി കാണപ്പെടുന്നു! പതിവ് നിരീക്ഷണം തുടരുകയും നല്ല കാർഷിക രീതികൾ നിലനിർത്തുകയും ചെയ്യുക.';
  ...
  String get uploadImageAndAnalyze =>
      'ഒരു ചിത്രം അപ്‌ലോഡ് ചെയ്ത് കീടങ്ങളെ കണ്ടെത്താനും ശുപാർശകൾ ലഭിക്കാനും \"വിശകലനം ചെയ്യുക\" ടാപ്പ് ചെയ്യുക';
  ...
  String get takeClearPhotos =>
      'ചെടിയുടെ ഇലകളുടെ വ്യക്തമായ, നന്നായി പ്രകാശമുള്ള ഫോട്ടോകൾ എടുക്കുക';

  @override
  String get focusOnAffectedAreas =>
      'ദൃശ്യമായ ലക്ഷണങ്ങളുള്ള ബാധിത പ്രദേശങ്ങളിൽ ശ്രദ്ധ കേന്ദ്രീകരിക്കുക';
  ...
  String get includeMultipleLeaves =>
      'സാധ്യമെങ്കിൽ ഒന്നിലധികം ഇലകൾ ഉൾപ്പെടുത്തുക';
  ...
  String get basedOn30DayForecast =>
      '30-ദിവസത്തെ കാലാവസ്ഥാ പ്രവചനത്തെ അടിസ്ഥാനമാക്കി';

  @override
  String get basedOnCurrentConditions =>
      'വर्तमान കാലാവസ്ഥാ സാഹചര്യങ്ങളെ അടിസ്ഥാനമാക്കി';
}
